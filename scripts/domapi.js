...
function main() {                                              //W3D5(2:36:)
    ...
    document.querySelector("#range1").onchange = (ev) => {    //W4D2 (1:20:)
        addRanges();                                         // ev = event
    }
...
function init(){                                         //W4D2 (1:13:)(1:20)
    ...
    function addRanges() {                                    //W4D2 (1:20:)
        ...
        document.querySelector("#res1").innerText ="Resulting SUM is "+(v1+v2);//W4D2 (1:15:)
        const inp61 = document.querySelector(".inp61");
        inp61.value = v1;
        document.querySelector(".inp62").value = v2;
